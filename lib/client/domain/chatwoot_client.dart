...
import 'package:chatwoot_sdk/client/data/socket/chatwoot_action_cable_client.dart';
import 'package:chatwoot_sdk/client/data/socket/chatwoot_cable_uri.dart';
...
class ChatwootClient {
  ...
  Future<void> init({
    ...
    if (activeSession != null) {
      ...
      _session = ChatwootSession(
        ...
        pubsubToken: sessionDto.pubsubToken,
  ...
  Future<void> _connectCable() async {
    ...
    _cable = ChatwootActionCableClient(
      ...
      pubsubToken: _session!.pubsubToken,
